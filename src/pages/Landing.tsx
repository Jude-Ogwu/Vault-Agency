  ...
  const steps = [
    {
      icon: Wallet,
      title: "Buyer Pays",
      description: "Buyer creates a transaction and makes payment. Funds are securely held by TrustLock.",
    },
    {
      icon: Package,
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-4 py-20 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg text-muted-foreground md:text-xl max-w-2xl mx-auto">
              TrustLock protects your transactions by holding funds until both parties are satisfied.
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold md:text-4xl">How TrustLock Works</h2>
      ...
      <section className="bg-muted/30 py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold md:text-4xl">Why Choose TrustLock?</h2>
            <p className="text-muted-foreground">
          ...
          <Card className="overflow-hidden border-0 gradient-hero">
            <CardContent className="p-12 md:p-16 text-center text-primary-foreground">
              ...
              <p className="mb-8 text-lg opacity-90 max-w-2xl mx-auto">
                Join thousands of Nigerians who trust TrustLock for their online transactions.
              </p>
              <Button
                size="lg"
                variant="secondary"
