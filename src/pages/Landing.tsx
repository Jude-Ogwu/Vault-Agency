  ...
  const steps = [
    {
      icon: Wallet,
      title: "Buyer Pays",
      description: "Buyer creates a transaction and makes payment. Funds are securely held by Vault Agency.",
    },
    {
      icon: Package,
        ...
        <div className="container mx-auto px-4 py-20 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg text-muted-foreground md:text-xl max-w-2xl mx-auto">
              Vault Agency protects your transactions by holding funds until both parties are satisfied.
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold md:text-4xl">How Vault Agency Works</h2>
