            ...
            <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
                ...
                <div className="prose prose-slate max-w-none dark:prose-invert space-y-8">
                    <section>
                        ...
                        <p>
                            At Escrow Nigeria ("EN"), we prioritize the safety of your funds. Our Refund Policy implies that funds are held securely until the transaction is successfully completed. Refunds are issued in specific scenarios as outlined below.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-6 mt-2 space-y-2">
                            ...
                            <li><strong>Review:</strong> EN Admin reviews the request and may ask for evidence from both parties (photos, tracking, chat history).</li>
                    ...
                    <section>
                        ...
                        <p>
                            Initiating a chargeback with your bank without first contacting Escrow Nigeria to resolve the issue is a violation of our Terms of Service. This may result in the permanent suspension of your account and legal action to recover disputed funds.
                        </p>
                    </section>
                </div>
            </main>
