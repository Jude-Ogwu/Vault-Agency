            ...
            <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
                ...
                <div className="prose prose-slate max-w-none dark:prose-invert space-y-8">
                    <section>
                        ...
                        <p>
                            Vault Agency ("VA", "we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclosure, and safeguard your information when you visit our website or use our escrow services.
                        </p>
                    </section>
