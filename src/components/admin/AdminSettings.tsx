...
const SETTING_LABELS: Record<string, { label: string; description: string; icon: React.ElementType; group: string }> = {
    service_fee_percent: { label: "Standard Fee (%)", description: "Fee for NGN transactions below threshold", icon: Percent, group: "Business" },
    high_value_fee_percent: { label: "High Value Fee (%)", description: "Fee for NGN transactions above threshold", icon: Percent, group: "Business" },
    high_value_threshold: { label: "High Value Threshold (NGN)", description: "Amount where high value fee applies", icon: Wallet, group: "Business" },
    crypto_service_fee_percent: { label: "Crypto Standard Fee (%)", description: "Fee for USD crypto below threshold", icon: Percent, group: "Business" },
    crypto_high_value_fee_percent: { label: "Crypto High Value Fee (%)", description: "Fee for USD crypto above threshold", icon: Percent, group: "Business" },
    crypto_high_value_threshold: { label: "Crypto High Value Threshold (USD)", description: "Amount where high value crypto fee applies", icon: Wallet, group: "Business" },
    admin_email: { label: "EN Email", description: "Email for all notifications", icon: Mail, group: "Contact" },
    ...
    bank_account_name: { label: "Bank Account Name", description: "e.g. Escrow Nigeria", icon: Wallet, group: "Bank Details" },
    bank_account_number: { label: "Bank Account Number", description: "e.g. 8144919893", icon: Wallet, group: "Bank Details" },
    bank_name: { label: "Bank Name", description: "e.g. Moniepoint", icon: Wallet, group: "Bank Details" },
